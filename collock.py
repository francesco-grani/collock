...
def build_system_prompt(persona: str, role: str, difficulty: str, interview_type: str, is_summary: bool = False) -> str:
    ...
    if not is_summary:
        ...
        return (
            ...
            "[1-2 sentences of overall feedback on the candidate's performance in this session, honest and linked to the quality of the answers that the candidate gave.]"
            "<br>"
            "<b>Strenghts:</b>"
